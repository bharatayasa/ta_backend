...
app.get('/users/me', verifyAccessToken, (req, res) => {
...
app.get('/admin/users', verifyAccessToken, (req, res) => {
...
app.post('/admin/adduser', verifyAccessToken, (req, res) => {
...
app.put('/admin/updateuser/:id', verifyAccessToken, (req, res) => {
    const { id } = req.params;
    const { username, name, email, password, role } = req.body;
...
app.delete('/admin/deleteuser/:id', verifyAccessToken, (req, res) => {
    const { id } = req.params;
